...
export default function Practice() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Side Navbar */}
      <aside className="w-64 bg-gray-800 text-gray-200 p-4 space-y-3">
        ...
        <ul className="space-y-2">
          ...
          <div className="text-white cursor-pointer " id="1"  
          //  onClick={handleListing}
          >
             School
          </div>

          <div className="text-white cursor-pointer" id="2"
          // onClick={handleListing}
          >
              Easy
          </div>

          <div className="text-white cursor-pointer" id="3"
          // onClick={handleListing}
          >
              medium
          </div>

          <div className="text-white cursor-pointer" id="4"
          // onClick={handleListing}
          >
              hard
          </div>
